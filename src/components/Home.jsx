...
const Landing = () => {
    ...
    return (
        <div className='h-full w-full bg-[#282c37] rounded-lg'>
            {showPost ? <PostSingle postInfo={showPost} setShowPost={setShowPost}/>
             ...
             <>
                ...
                <div className=' flex flex-col w-full h-[90%] overflow-y-scroll scrollbar:bg-blue-500 rounded-xl scrollbar scrollbar-thumb-blue-500 scrollbar-track-gray-200'>
