    ...
    <div className="w-screen h-screen flex flex-col justify-center items-center bg-[#282c37] text-white">
      ...
      <form className="w-[80%] h-[50%] flex flex-col items-center justify-evenly relative" onSubmit={signIn}>
        ...
        <div className='w-3/4 h-fit lg:w-1/3 lg:h-1/2 p-4 absolute bg-[#14161bda] text-white bottpm:1/4 left:1/2 lg:-right-16 lg:-top-28 border-[#787ad9] border-2'>
          ...
          <input type="password" name="password" id="password" placeholder='Password' className={"w-3/4 lg:w-2/5 py-2 px-4 bg-[#14161b] border-[#464b5f] border-[1px] rounded-md focus:border-[1px] focus:border-[#787ad9] outline-none " + (error?.password ? 'border-red-500 focus:border-red-500' : '')} />
