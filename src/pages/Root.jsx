...
const Root = () => {
  ...
  return (
    <div className='w-screen h-screen lg:grid lg:grid-cols-[25%_50%_25%] bg-[#191b22]'>
      <div className='w-full lg:h-screen p-4 flex justify-between items-center lg:flex lg:flex-col '> {/* Navigation bar */}
        <div className='w-full h-4/6 text-[#d9e1e8] flex lg:flex-col'>
  ...
  <path d="M12 5.432l8.159 8.159c.03.03.06.058.091.086v6.198c0 1.035-.84 1.875-1.875 1.875H15a.75.75 0 01-.75-.75v-4.5a.75.75 0 00-.75-.75h-3a.75.75 0 00-.75.75V21a.75.75 0 01-.75.75H5.625a1.875 1.875 0 01-1.875-1.875v-6.198a2.29 2.29 0 00.091-.086L12 5.43z" />
          ...
          {user && <button onClick={logout} className='w-3/4 py-2 self-center border-2 border-[#595aff] text-[#595aff] rounded-md'>Log out</button>}
        </div>
      </div>
